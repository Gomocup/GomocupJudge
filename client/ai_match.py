...
class ai_match(object):
    ...
    def next_move(self):
        ...
        if self.move_num == 0:
            ...
            if self.engine_1 is None:
                self.engine_1 = self.init_protocol(self.cmd_1, self.protocol_1, self.board_1, self.timeout_turn_1, self.timeout_match_1, self.max_memory_1, self.game_type, self.rule, self.folder_1, self.working_dir_1, self.tolerance)
            else:
            ...
            if self.engine_2 is None:
                self.engine_2 = self.init_protocol(self.cmd_2, self.protocol_2, self.board_2, self.timeout_turn_2, self.timeout_match_2, self.max_memory_2, self.game_type, self.rule, self.folder_2, self.working_dir_2, self.tolerance)
            else:
    ...
    def init_protocol(self, cmd, protocol_type, board, timeout_turn=30 * 1000, timeout_match=180 * 1000, max_memory=350 * 1024 * 1024, game_type=1, rule=0, folder="./", working_dir="./", tolerance=1000):
